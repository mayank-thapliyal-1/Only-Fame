  ...
  return (
    <nav className=" flex justify-around p-5 pt-10  w-full fixed items-center bg-white z-50">
      ...
      <div className=" flex gap-16 items-center">
        <span className="cursor-pointer"> 👉🏻 For Creators</span>
        ...
        <span className="text-[#5811A6] box-border border-[0.5px]  font-semibold hover:border-[2px] hover:border-[#bea1dd] bg-[#F4E8FF]  px-7 py-1 rounded-4xl cursor-pointer">
          {" "}
          Login{" "}
        </span>
      </div>
